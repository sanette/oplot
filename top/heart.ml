...
display [v; Color black ; a; line_width 2.; Color blue;
         simplify_line ~epsilon:0.0001 ctr]
...
(* 6. Simplifying the curves... be patient because it has hundreds of thousands
   of paths! *)

print_endline "Simplifying curve...";;
let spl = Debug.timeit (fun () -> simplify_line ~epsilon:0.0001 ctr);;
print_endline "Exporting to PDF...";;
Debug.timeit (fun () ->
    display [v; Color blue; spl] ~dev:pdf ~output:"heart_chaotic_simplified.pdf");;
print_endline "Done.";;
