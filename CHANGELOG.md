...
* Add `connect_lines` (Path module) This is a nice algorithm to
  "connect lines that can be connected", example:
  [a,b] [b,c,d] [d,e] -> [a,b,c,d,e].
  This can result in spectacular simplification, (and faster and sharper
  PDF output) especially for lines generated by `implicit_plot`.
