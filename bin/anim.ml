...
display [  v; Color red; t; Color cyan; ap;
           Color blue; text "The curve is continuously updated." 10. (-. 0.5) ] ~dev:gl;;
...
display [ v;  Color green; t; Color cyan; User user; Color blue;
          text "The curve is updated only when some event occurs." 10. (-. 0.5) ] ~dev:gl;;
